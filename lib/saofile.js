...
const getMasterUrl = (originalUrl) => {
    const url = originalUrl.replace(/^git\+|\.git$/g, '');
    return `${url}/src/master`;
}
...
module.exports = {
    ...
    templateData () {
        ...
        return {
            ...
            pkgMasterUrl: getMasterUrl(mainPkg.repository.url || mainPkg.repository),
        }
    },
    actions() {
